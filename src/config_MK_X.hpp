...
/////////-PARAMETRI-////////////
#define NomeMacchinina "MK_X"

#ifdef ServoAnteriore
    uint8_t ValSx=140; //valore servo per sterzo a sinistra
    uint8_t ValDx=15;  //valore servo per sterzo a destra
    ...
    int TempoBoostSterzo=200; //tempo di boost iniziale sterzo in millisecondi
#endif
...
uint8_t ValMaxMotoreVEL[] = {0, 110, 125, 145, 160, 180}; // Indice 0 non usato
uint8_t ConfigurazioniLED[][3] = {
  {0, 0, 0},     // Marcia 0 (non usata)
  {0, 0, 1},     // Marcia 1: BLU
  {0, 1, 1},     // Marcia 2: VERDE + BLU  
  {0, 1, 0},     // Marcia 3: VERDE
  {1, 1, 0},     // Marcia 4: ROSSO + VERDE
  {1, 0, 0}      // Marcia 5: ROSSO
};
uint8_t ConfigurazioneBuzzer[] = {0, 1, 1, 1, 1, 2};
