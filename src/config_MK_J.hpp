...
/////////-PARAMETRI-////////////
#define NomeMacchinina "MK_J"

#ifdef ServoAnteriore
    uint8_t ValSx=130; //valore servo per sterzo a sinistra
    uint8_t ValDx=48;  //valore servo per sterzo a destra
    uint8_t Val0=95;   //valore servo per sterzo al centro
